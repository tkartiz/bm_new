                                                ...
                                                <tr>
                                                    <td class="px-2 py-3 w-2/12">
                                                        <select v-model="form.creator_id"
                                                            ...
                                                            <option v-if="user.roll === 'admin'" v-for="creator in creators"
                                                                :key="creator.id" :value="creator.id">{{ creator.name }}
                                                            </option>
                                                            <option v-if="user.roll === 'creator'" :value="creators.id">{{
                                                                creators.name }}</option>
                                                        </select>
                                                    </td>
                                                    <td class="px-2 py-3 w-1/12">
                                                        <select v-model="form.outsourcing"
                                                            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
