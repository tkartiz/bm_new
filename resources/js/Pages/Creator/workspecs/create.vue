                    ...
                    <section class="text-gray-600 body-font relative">
                        ...
                        <div class="p-3 flex flex-wrap bg-white">
                            ...
                            <form @submit.prevent="storeWorkspec(user.id)">
                                <input type="integer" id="application_id" name="application_id"
                                    v-bind:value="application.id" class="hidden" />
                                <div class="w-full pt-3 text-center">
                                    ...
                                    <div class="w-full mx-auto my-10">
                                        <button type="submit"
                                            class="w-1/2 py-2 text-white bg-indigo-500 border-0 focus:outline-none hover:bg-indigo-600 rounded-l-xl">登録する</button>
                                        <Link as="button" :href="route('creator.workspecs.index', { application: application.id })"
