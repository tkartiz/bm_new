...
const updateWorkspec = (id) => {
    ...
    Inertia.put(route('creator.workspecs.update', { workspec: id }), form);
}
                                ...
                                <form @submit.prevent="updateWorkspec(form.id)">
                                    ...
                                    <div class="p-2 w-full text-center">
                                        ...
                                        <div class="w-full mx-auto my-10">
                                            ...
                                            <Link as="button" :href="route('creator.workspecs.index', { application: application.id })" class="w-1/2 py-2 text-white bg-pink-500 border-0 focus:outline-none hover:bg-pink-600 rounded-r-xl">戻る</Link>
                                        </div>
                                    </div>
                                </form>
                            </div>
