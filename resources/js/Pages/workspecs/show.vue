...
const deleteWorkspec = id => {
    Inertia.delete(route('workspecs.destroy', { workspec: id }), {
                    ...
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-8 mx-auto">
                            ...
                            <div class="w-full mx-auto my-10">
                                <Link as="button" :href="route('workspecs.edit', {workspec: workspec.id})" class="w-1/3 py-2 text-white bg-indigo-500 border-0 focus:outline-none hover:bg-indigo-600 rounded-l-xl">
                                    編集する
                                </Link>
                                ...
                                削除する</button>
                                <Link as="button" :href="route('workspecs.index', {application: application.id})" class="w-1/3 py-2 text-white bg-pink-500 border-0 focus:outline-none hover:bg-pink-600 rounded-r-xl">
                                    戻る
                                </Link>
                            </div>
                        </div>
