                        ...
                        <section class="text-gray-600 body-font relative">
                            ...
                            <form @submit.prevent="updateOutsourcing(form.id)">
                                ...
                                <div class="p-3 bg-white">
                                    ...
                                    <div class="p-2 w-full flex">
                                        <label for="comp_price_exc"
                                            class="w-40 leading-7 text-sm text-gray-600">金額（税抜）</label>
                                        <input type="text" id="comp_price_exc" v-model="form.comp_price_exc"
                                            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                    </div>
                                    <div class="p-2 w-full flex">
                                        <label for="comp_price_incl"
                                            class="w-40 leading-7 text-sm text-gray-600">金額（税込）</label>
                                    ...
                                    <div class="p-2 w-full flex">
                                        ...
                                        <input id="comp_file1" type="file" @input="form.comp_file1 = $event.target.files[0]"
                                            class="w-4/5">
                                    </div>
                                    <div class="p-2 w-full flex">
                                        <label for="comp_file2" class="w-40 leading-7 text-sm text-gray-600">見積もり２</label>
                                        <input id="comp_file2" type="file" @input="form.comp_file2 = $event.target.files[0]"
                                            class="w-4/5">
                                    </div>
                                    <div class="p-2 w-full flex">
                                        <label for="comp_file3" class="w-40 leading-7 text-sm text-gray-600">見積もり３</label>
                                        <input id="comp_file3" type="file" @input="form.comp_file3 = $event.target.files[0]"
                                            class="w-4/5">
                                    </div>
                                </div>
                                <div class="w-full mx-auto my-10">
                                    ...
                                    <Link as="button"
                                        :href="route('admin.os_appds.edit', { os_appd: outsourcing.os_appd_id })"
